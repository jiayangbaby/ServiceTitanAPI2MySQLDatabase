...
JOBS_URL = "https://api.servicetitan.io/jpm/v2/tenant/{tenant}/jobs"
CLIENT_ID = os.getenv("CLIENT_ID")
CLIENT_SECRET = os.getenv("CLIENT_SECRET")
ST_APP_KEY = os.getenv("ST_APP_KEY")
TENANT = os.getenv("TENANT")
OUTPUT_BASE_DIR = os.getenv("OUTPUT_CSV")
OUTPUT_CSV = os.path.join(OUTPUT_BASE_DIR, "jobs_data.csv")
...
def main():
    try:
        ...
        while has_more:
            ...
            jobs_data = get_jobs_data(access_token, page)
